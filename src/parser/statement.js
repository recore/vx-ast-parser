...
export default class StatementParser extends ExpressionParser {
  ...
  parseForStatement(node: N.Node): N.ForLike {
    ...
    if (this.match(tt._var) || this.match(tt._let) || this.match(tt._const)) {
      ...
      if (this.match(tt._in) || this.match(tt._of) || this.isContextual("of")) {
    ...
    if (this.match(tt._in) || this.match(tt._of) || this.isContextual("of")) {
      const description = this.match(tt._in)
        ? "for-in statement"
        : "for-of statement";
  ...
  parseVar(
    ...
    for (;;) {
      ...
      if (this.eat(tt.eq)) {
        ...
        if (
          kind === tt._const &&
          !(this.match(tt._in) || this.match(tt._of) || this.isContextual("of"))
        ) {
          ...
          !(isFor && (this.match(tt._in) || this.match(tt._of) || this.isContextual("of")))
        ) {
          this.raise(
